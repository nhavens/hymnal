...
public class TopLevelChooserPanel extends ChooserPanel
    ...
    private static final String LIST_TOOLTIP_TEXT = 
        "Select either " + TEXT_STRING + " or " + TUNE_STRING;
    ...
    public TopLevelChooserPanel(Model model) {
		...
		list.setCellRenderer(new StandardCellRenderer<String>());	
