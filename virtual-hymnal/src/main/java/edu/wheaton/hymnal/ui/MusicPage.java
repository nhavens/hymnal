...
public class MusicPage extends JFrame implements Observer {
	...
	private JComboBox<Text> textList;
	private JComboBox<Tune> tuneList;
	...
	public MusicPage(final Model model, final Chooser chooser) {
		...
		this.textList = new JComboBox<Text>();
		this.tuneList = new JComboBox<Tune>();
	...
	public void render() {
		...
		textList.setModel(new DefaultComboBoxModel<Text>(db
				.selectTextsFor(model.getTune())));
		tuneList.setModel(new DefaultComboBoxModel<Tune>(db
				.selectTunesFor(model.getText())));
		setSelectedItems();
